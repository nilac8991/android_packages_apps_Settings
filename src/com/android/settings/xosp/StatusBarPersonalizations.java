...
public class StatusBarPersonalizations extends SettingsPreferenceFragment
    ...
    private static final String NETWORK_TRAFFIC_STATE = "network_traffic-state";
    private static final String NETWORK_TARFFIC_UNIT = "network_traffic_unit";
    private static final String NETWORK_TRAFFIC_PERIOD = "network_traffic_period";
    private static final String NETWORK_TARFFIC_AUTOHIDE = "network_traffic_autohide";
    private static final String NETWORK_TRAFFIC_AUTOHIDE_THRESHOLD = "netowrk_traffic_autohide_threshold";
